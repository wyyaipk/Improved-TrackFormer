...
ex.add_config('/home/dell/PK/trackformer_1_v48/cfgs/train.yaml')
ex.add_named_config('deformable', '/home/dell/PK/trackformer_1_v48/cfgs/train_deformable.yaml')
ex.add_named_config('tracking', '/home/dell/PK/trackformer_1_v48/cfgs/train_tracking.yaml')
ex.add_named_config('crowdhuman', '/home/dell/PK/trackformer_1_v48/cfgs/train_crowdhuman.yaml')
ex.add_named_config('mot_coco_person', '/home/dell/PK/trackformer_1_v48/cfgs/train_mot_coco_person.yaml')
ex.add_named_config('mot17_crowdhuman', '/home/dell/PK/trackformer_1_v48/cfgs/train_mot17_crowdhuman.yaml')
ex.add_named_config('mot17', '/home/dell/PK/trackformer_1_v48/cfgs/train_mot17.yaml')
ex.add_named_config('mot16', '/home/dell/PK/trackformer_1_v48/cfgs/train_mot16.yaml')
ex.add_named_config('mot20', '/home/dell/PK/trackformer_1_v48/cfgs/train_mot20.yaml')
ex.add_named_config('mots20', '/home/dell/PK/trackformer_1_v48/cfgs/train_mots20.yaml')
ex.add_named_config('mot20_crowdhuman', '/home/dell/PK/trackformer_1_v48/cfgs/train_mot20_crowdhuman.yaml')
ex.add_named_config('coco_person_masks', '/home/dell/PK/trackformer_1_v48/cfgs/train_coco_person_masks.yaml')
ex.add_named_config('full_res', '/home/dell/PK/trackformer_1_v48/cfgs/train_full_res.yaml')
ex.add_named_config('multi_frame', '/home/dell/PK/trackformer_1_v48/cfgs/train_multi_frame.yaml')
...
def train(args: Namespace) -> None:
    ...
    for epoch in range(args.start_epoch, args.epochs + 1):
        ...
        # VAL
        if epoch == 1 or not epoch % args.val_interval or epoch >= 45:
        ...
        # MODEL SAVING
        if args.output_dir:
            if args.save_model_interval and (not epoch % args.save_model_interval or epoch >= 45):
