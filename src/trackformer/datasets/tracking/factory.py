...
from .mot_wrapper import MOT17Wrapper, MOT20Wrapper, MOTS20Wrapper, MOT16Wrapper
...
for split in ['TRAIN', 'TEST', 'ALL', '01', '02', '03', '04', '05',
    ...
    name = f'MOT16-{split}'
    DATASETS[name] = (
        lambda kwargs, split=split: MOT16Wrapper(split, **kwargs))
""""""
    ...
    def __init__(self, datasets: Union[str, list], **kwargs) -> None:
        ...
        for dataset in datasets:
            ...
            if self._data is None:
                self._data = DATASETS[dataset](kwargs) # kwargs={'root_dir','img_transform'}
            else:
