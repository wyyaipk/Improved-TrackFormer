...
class MOT17Sequence(Dataset):
    ...
    def __init__(self, root_dir: str = '/home/dell/PK/DataSet', seq_name: Optional[str] = None,
    ...
    def get_det_file_path(self) -> str:
        ...
        """修改处，为MOT20、MOT16添加公共评测"""
        if self._dets == None and ('MOT20' == self.data_folder or 'MOT16' == self.data_folder):
            return osp.join(self.get_seq_path(), 'det', 'det.txt')
        elif self._dets is None:
            return ""
