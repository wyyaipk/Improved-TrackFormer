...
from .mot16_sequence import MOT16Sequence
...
class MOT16Wrapper(Dataset):
    ...
    def __init__(self, split: str, **kwargs) -> None:
        ...
        test_sequences = [
            'MOT16-01', 'MOT16-03', 'MOT16-06', 'MOT16-07',
        ...
        if split == "TRAIN":
            ...
            raise NotImplementedError("MOT16 split not available.")

        self._data = []
        for seq in sequences:
            self._data.append(MOT16Sequence(seq_name=seq, dets=None, **kwargs))
