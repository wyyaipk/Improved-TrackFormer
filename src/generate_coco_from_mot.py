...
def generate_coco_from_mot(split_name='train', seqs_names=None,
                           ...
                           frame_range=None, data_root='/home/dell/PK/DataSet/MOT16'):
    """
...
def check_coco_from_mot(coco_dir='data/MOT16/mot16_train_coco', annotation_file='data/MOT16/annotations/mot16_train_coco.json', img_id=None):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mot16', action='store_true')
    ...
    if args.mots20:
        ...
        data_root = '/home/spl/PK/DataSet/MOT20'
        ...
        data_root = '/home/dell/PK/DataSet/MOT16'
        #
        # MOT16
        #
        ...
        # # CROSS VAL SPLIT 1
        # generate_coco_from_mot(
        #     'mot16_train_cross_val_1_coco',
        #     seqs_names=['MOT16-04', 'MOT16-05', 'MOT16-09', 'MOT16-11'])
        # generate_coco_from_mot(
        #     'mot16_val_cross_val_1_coco',
        #     seqs_names=['MOT16-02', 'MOT16-10', 'MOT16-13'])
        #
        # # CROSS VAL SPLIT 2
        # generate_coco_from_mot(
        #     'mot16_train_cross_val_2_coco',
        #     seqs_names=['MOT16-02', 'MOT16-05', 'MOT16-09', 'MOT16-10', 'MOT16-13'])
        # generate_coco_from_mot(
        #     'mot16_val_cross_val_2_coco',
        #     seqs_names=['MOT16-04', 'MOT16-11'])
        #
        # # CROSS VAL SPLIT 3
        # generate_coco_from_mot(
        #     'mot16_train_cross_val_3_coco',
        #     seqs_names=['MOT16-02', 'MOT16-04', 'MOT16-10', 'MOT16-11', 'MOT16-13'])
        # generate_coco_from_mot(
        #     'mot16_val_cross_val_3_coco',
        #     seqs_names=['MOT16-05', 'MOT16-09'])
        #
        # # CROSS VAL FRAME SPLIT
        # generate_coco_from_mot(
        #     'mot16_train_cross_val_frame_0_0_to_0_25_coco',
        #     seqs_names=['MOT16-02', 'MOT16-04', 'MOT16-05', 'MOT16-09', 'MOT16-10',
        #                 'MOT16-11', 'MOT16-13'],
        #     frame_range={'start': 0, 'end': 0.25})
        # generate_coco_from_mot(
        #     'mot16_train_cross_val_frame_0_0_to_0_5_coco',
        #     seqs_names=['MOT16-02', 'MOT16-04', 'MOT16-05', 'MOT16-09', 'MOT16-10',
        #                 'MOT16-11', 'MOT16-13'],
        #     frame_range={'start': 0, 'end': 0.5})
        generate_coco_from_mot(
            'mot16_train_cross_val_frame_0_5_to_1_0_coco',
            seqs_names=['MOT16-02', 'MOT16-04', 'MOT16-05', 'MOT16-09', 'MOT16-10',
                        'MOT16-11', 'MOT16-13'],
            frame_range={'start': 0.5, 'end': 1.0})

        # generate_coco_from_mot(
        #     'mot16_train_cross_val_frame_0_75_to_1_0_coco',
        #     seqs_names=['MOT16-02', 'MOT16-04', 'MOT16-05', 'MOT16-09', 'MOT16-10',
        #                 'MOT16-11', 'MOT16-13'],
        ...
        #
        #     generate_coco_from_mot(
        #         f'mot16_train_{i + 1}_coco',
        #         seqs_names=train_seqs)
        #     generate_coco_from_mot(
        #         f'mot16_val_{i + 1}_coco',
        #         seqs_names=val_seqs)
